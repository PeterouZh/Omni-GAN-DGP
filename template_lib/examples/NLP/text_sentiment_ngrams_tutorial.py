...
Original file is located at
    https://colab.research.google.com/github/pytorch/tutorials/blob/gh-pages/_downloads/text_sentiment_ngrams_tutorial.ipynb
"""
...
train_dataset, test_dataset = torchtext.datasets.AG_NEWS(
    './datasets', ngrams=NGRAMS, vocab=None,
    download=False, extracted_files=['./datasets/ag_news_csv/train.csv', './datasets/ag_news_csv/test.csv'])
# train_dataset, test_dataset = text_classification.DATASETS['AG_NEWS'](
#     root='./datasets', ngrams=NGRAMS, vocab=None)
...
def train_func(sub_train_):
    ...
    for i, (text, offsets, cls) in enumerate(tqdm.tqdm(data)):
        optimizer.zero_grad()
